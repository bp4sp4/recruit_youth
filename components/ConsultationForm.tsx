...
export default function ConsultationForm() {
  const [formData, setFormData] = useState<
    Omit<
      ...
      "id" | "created_at" | "updated_at" | "region"
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (utmSource) {
        ...
        if (
          referrerLower.includes("naver.com") ||
          referrerLower.includes("search.naver")
        ) {
          source = "네이버 검색";
        } else if (
          referrerLower.includes("daangn.com") ||
          referrerLower.includes("당근")
        ) {
          source = "당근";
        } else if (
          referrerLower.includes("instagram.com") ||
          referrerLower.includes("instagr.am")
        ) {
          source = "인스타";
        } else {
          source = "기타";
  ...
  const regionOptions: ("서울" | "경기인천" | "그 외지역")[] = [
    "서울",
    "경기인천",
    "그 외지역",
  ];
      ...
      <div className="rounded-3xl">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label
              htmlFor="name"
              className="block text-xs md:text-sm font-medium text-gray-900 mb-3"
            >
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={() =>
                        setFormData({
                          ...formData,
                          region: formData.region === region ? "" : region,
                        })
                      }
