...
export default function Home() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (!footerRef.current || !mainRef.current || !formSectionRef.current)
        return;
      ...
      const mainMiddle =
        mainRef.current.offsetTop + mainRef.current.offsetHeight / 2;
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 bg-white border-b border-gray-200 z-30">
        <div
          className="container mx-auto md:px-0 px-4 py-4 flex justify-between items-center"
      ...
      <main ref={mainRef} className="flex flex-col items-center justify-center">
        <div
          className="text-center space-y-8 w-full bg-gray-100"
